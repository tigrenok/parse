					...
					if($model->validate())
					{
						...
						if ($model->save()) {
							...
							$mailer=Yii::app()->mailer;
                                                        ...
                                                        $mailer->Subject = Yii::t('user', 'Регистрация');
                                                        $mailer->Body = $this->renderFile('protected/views/email/register.php', array('login'=>$model->email,'pass'=>$soucePassword,'activate_url' => $activation_url, 'salt' => $model->activkey), true);
                                                        $mailer->Send();
